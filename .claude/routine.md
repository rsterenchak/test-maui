...
This file documents the project-specific commands, conventions, and quirks for **test-maui**. It supplements `routine-base.md` (which has the universal discipline) with project-specific details Claude runs need to know.
...
**Variant:** (none — maui project) (either `gen-src-manifest.js` for CommonJS projects or `gen-src-manifest.cjs` for ESM projects with `"type": "module"` in package.json)
...
>
> - "test-maui is a single-page app; routing is hash-based via {{ROUTER_FILE}}."
